        ...
        <div class="authentication-inner py-4">
          ...
          <div class="card p-2">
            ...
            <div class="card-body mt-2">
              <h4 class="mb-2 text-center">Selamat Datang di BKK SMK YPC!👋</h4>
              <p class="mb-4 text-center">Mohon Masukan Nisn dan Password</p>

              <form id="formAuthentication" class="mb-3" action="{{ url('/loginalumni') }}" method="POST">
                @csrf
                <div class="form-floating form-floating-outline mb-3">
                  <input type="text" class="form-control" id="nisn" name="nisn" placeholder="Enter your nisn"autofocus />
