            ...
            <div class="card">
              <div class="row">
                <div class="col-6">
                  <div class="card-body">
                    <div class="card-info">
                      <h6 class="mb-4 pb-1 text-nowrap">Alumni</h6>
                      <div class="d-flex align-items-end mb-3 ">
                        <h3 class="mb-0 me-2">{{ $jumlah_alumni }}</h3>
            ...
            <div class="card">
              <div class="row">
                <div class="col-6">
                  <div class="card-body">
                    <div class="card-info">
                      <h6 class="mb-4 pb-1 text-nowrap">Lamaran</h6>
                      <div class="d-flex align-items-end mb-3">
                        <h4 class="mb-0 me-2">{{ $jumlah_lamaran }}</h4>
                        <small class="text-success">lamaran</small>
                      </div>
          ...
          <div class="col-xl-6 align-self-end">
            <div class="card">
              <div class="card-header d-flex align-items-center justify-content-between">
                <h5 class="card-title m-0 me-2">BKK SMK YPC</h5>
                <div class="dropdown">
                ...
                <div class="row g-3 mb-xl-2">
                  ...
                  <div class="col-md-4">
                    <div class="d-flex align-items-center">
                      ...
                      <div class="ms-3">
                        <div class="small mb-1">Perusahaan</div>
                        <h5 class="mb-0">{{ $jumlah_perusahaan }}</h5>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="d-flex align-items-center">
                      <div class="avatar">
                        <div class="avatar-initial bg-warning rounded shadow">
                          <i class="mdi mdi mdi-package-up mdi-24px"></i>
                        </div>
                      </div>
                      <div class="ms-3">
                        <div class="small mb-1">Lowongan</div>
                        <h5 class="mb-0">{{ $jumlah_lowongan }}</h5>
                      </div>
                    </div>
                  </div>
                </div>
