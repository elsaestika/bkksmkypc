...
<body>
    <div class="container-fluid pt-5 mt-5">
        ...
        <div class="col-md-10">
            <div class="card">
                <div class="card-body">
                    <form action="{{ url('create/loker') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-lg-12 col-6">
                                ...
                                <div class="input-icon mb-3">
                                    ...
                                    <input type="text" value="" id="lowongan" class="form-control" name="lowongan">
                                </div>
                                <div class="row">
                                    <div class="col mb-0">
                                        <div class="input-icon mb-3">
                                    ...
                                    <div class="col mb-0">
                                        <div class="input-icon mb-3">
                                            ...
                                            <input type="text" value="" id="syarat" class="form-control" name="syarat" >
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col mb-0">
                                        <div class="input-icon mb-3">
                                            ...
                                            <input type="text" value="" id="keahlian" class="form-control" name="keahlian" >
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col mb-0">
                                        <div class="input-icon mb-3">
                                            ...
                                            <input type="text" value="" id="kualifikasi" class="form-control" name="kualifikasi" >
                                        </div>
                                    </div>
                                    <div class="col mb-0">
                                        <div class="input-icon mb-3">
                                            <label for="form" class="form-label">Waktu Bekerja</label>
                                            <input type="text" value="" id="jam_kerja" class="form-control" name="jam_kerja" >
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col mb-0">
                                        <div class="input-icon mb-3">
                                            ...
                                            <input type="text" value="" id="gaji" class="form-control" name="gaji" >
                                        </div>
                                    </div>
                                    <div class="col mb-0">
                                        <div class="input-icon mb-3">
                                            <label for="form" class="form-label">Pendidikan</label>
                                            <input type="text" value="" id="pendidikan" class="form-control" name="pendidikan" >
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col mb-0">
                                        <div class="input-icon mb-3">
                                            ...
                                            <input type="text" value="" id="tipe_pekerjaan" class="form-control" name="tipe_pekerjaan" >
                                        </div>
                                    </div>
                                    {{-- <div class="col mb-0">
                                        <div class="input-icon mb-3">
